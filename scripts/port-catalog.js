...
export const INDIVIDUAL_RUNNERS = [
  ...
  },
  {
    ...
    tier: 'A',
    promotedToStudio: true,
    sourceDoc: 'docs/estrategias/hopper-3-maker-realista.md',
  },
  {
    id: 'hopper-4-v1',
    family: 'carry',
    ...
    tier: 'A',
    promotedToStudio: true,
    sourceDoc: 'docs/estrategias/hopper-4-otimizacao-risco-2026-07-14.md',
  },
  {
    id: 'escada-dupla-v1',
    family: 'carry',
  ...
  },
  {
    id: 'shotandgo-v1',
    family: 'carry',
    name: 'Shotandgo V1 (Phil Escada Dupla)',
    sourceFile: 'shotandgo-runner.js',
    createFn: 'createBacktestRunner',
    runnerSlug: 'shotandgo-runner',
    strategyLabel: 'SHOTANDGO_V1',
    usesStopReverse: true,
    tier: 'A',
    promotedToStudio: false,
    sourceDoc: 'docs/estrategias/nao-implementadas/shotandgo-v1.md',
  },
  {
    id: 'phil-hopper-relux5',
    family: 'carry',
    name: 'Phil Hopper Relux5',
    sourceFile: 'phil-hopper-relux5-runner.js',
    createFn: 'createBacktestRunner',
    runnerSlug: 'phil-hopper-relux5-runner',
    strategyLabel: 'PHIL_HOPPER_RELUX5',
    usesStopReverse: false,
    tier: 'A',
    promotedToStudio: false,
    sourceDoc: 'docs/estrategias/nao-implementadas/phil-hopper-relux5.md',
    notes: 'Fonte Phil_Hopper_Real_Redux_Relux5.py — distinto de shotandgo-v1',
  },
  {
