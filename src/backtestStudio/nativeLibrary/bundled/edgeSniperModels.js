/**
 * Native versioned models extracted from standardLibrary (hot path, V8-optimized).
 * Slug: edge-sniper-models @ version 1
 */
...
export function createEdgeSniperModels(lib) {
  function directionProbability(samples, tick, event, params = {}) {
  ...
  function scoreSides(samples, tick, event, params = {}) {
      const probUp = directionProbability(samples, tick, event, params);
  ...
  function scoreImpulseElasticitySides(samples, tick, event, params = {}) {
